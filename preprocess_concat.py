...
df = pd.read_csv('./cleaned_review/cleaned_review_치과.csv', index_col=0)
print(df.info())
df.drop_duplicates()
...
df.to_csv('./cleaned_review/cleaned_review_치과.csv')
...
print(df.info())
df.to_csv('./cleaned_review/total_cleaned_review.csv', encoding='utf-8-sig')
